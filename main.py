...
def fetch_live_world_tension():
    ...
    try:
        ...
        print("⚠ GDELT returned empty timeline. Using historical baseline.")
        return None

    except Exception as e:
        print(f"⚠ GDELT Client Error: {e}. Reverting to Historical CSV.")
        return None
...
def main():
    ...
    try:
        ...
        if missing:
            print(f"⚠ MISSING NODES (Sample): {list(missing)[:10]}")
